    ...
    <html lang="en" className="h-full">
      <body className="flex min-h-full flex-col">
        ...
        <footer className="border-t border-line-soft py-8">
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-1.5 px-5 text-center text-xs text-ink-soft/70 sm:flex-row sm:justify-between sm:text-left">
