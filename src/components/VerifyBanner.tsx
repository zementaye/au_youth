...
export default function VerifyBanner() {
  ...
  return (
    <div className="mb-8 flex flex-wrap items-center gap-3 rounded-lg border border-gold/40 bg-gold-soft/20 px-4 py-3 text-sm text-ink">
      ...
      {!sent && (
        <button
          ...
          className="rounded-full border border-ink/20 px-3 py-1 text-xs font-medium text-ink hover:border-ink disabled:opacity-60"
        >
